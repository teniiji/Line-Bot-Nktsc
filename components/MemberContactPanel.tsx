    ...
    <div className="bg-white rounded-lg shadow">
      <div className="flex items-center justify-between gap-3 px-4 py-3 border-b border-slate-100">
        <div>
          ...
          <PanelHelp summary="เปิดดูทั้งทะเบียน หรือค้นด้วยเลขสมาชิก ชื่อ หรือสังกัด — แก้เบอร์โทรและเลขบัตรประชาชนได้ทันทีเมื่อสมาชิกโทรแจ้ง">
            <p>
              ข้อมูลนี้ใช้ยืนยันตัวตนก่อนแจ้งเลขสมาชิกทาง LINE เท่านั้น คอลัมน์{" "}
              <strong>"เลขบัญชีที่ผูกไว้"</strong> คือทะเบียนเลขบัญชีเดียวกับที่แท็บ "เทียบ Statement"
              ดึงมาแสดงให้ตรงนี้ด้วย จะได้ไม่ต้องเปิดสองแท็บ
            </p>
            <p>
              คอลัมน์ "เชื่อมต่อ LINE" บอกว่าเลขสมาชิกนี้ผูกกับบัญชี LINE ไหนอยู่
