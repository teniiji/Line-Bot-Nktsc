    ...
    <div className="bg-white rounded-lg shadow">
      <div className="px-4 py-3 border-b border-slate-100">
        ...
        <p className="text-xs text-slate-500 mt-1">
          ...
          บอทจะแนะนำให้ติดต่อสำนักงานแทนเหมือนเดิม ⚠️{" "}
          <strong>ห้ามใช้ลิงก์จากเว็บไซต์สหกรณ์เอง (nktscoop.com)</strong> เพราะตรวจพบปัญหาความปลอดภัย —
          แนะนำอัปโหลดไฟล์ขึ้น Google Drive แล้วแชร์ลิงก์แบบ "ทุกคนที่มีลิงก์ดูได้" แทน
        </p>
      </div>
