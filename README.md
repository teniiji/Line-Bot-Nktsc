...
- `lib/financeAgent.ts` — นอกจากบันทึกธุรกรรม ยังยืนยันตัวตนสมาชิกกับ roster, ตรวจสลิป (ยอดตรง + บัญชีปลายทางเป็นสหกรณ์ + กันสลิปซ้ำด้วย SHA-256), และส่งต่อคำขอเอกสารประกอบไปยังเจ้าหน้าที่ที่รับผิดชอบ
