...
npx tsx scripts/import-org-data.ts <path-to-file.xlsx>      # นำเข้าสมาชิก/หน่วยงาน
npx tsx scripts/import-loan-contacts.ts <path-to-file.xlsx>  # นำเข้าผู้รับผิดชอบงานกู้เงิน
