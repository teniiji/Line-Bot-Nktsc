...
1. **บันทึกรายการ:** ตรวจสอบสลิป (ยอดตรง, บัญชีปลายทางสหกรณ์, ป้องกันสลิปซ้ำด้วย SHA-256) และแยกประเภทรายการ (ฝากเงิน, ซื้อหุ้น, ชำระหนี้) — ธุรกรรม "ชำระหนี้" ต้องระบุประเภทเงินกู้เพิ่ม และ "ฝากเงิน" ต้องระบุเลขที่บัญชีที่จะฝากเพิ่ม ก่อนจะบันทึกจริง
