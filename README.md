...
แผนกอื่นที่ไม่ใช่สินเชื่อ (เงินฝาก, สารสนเทศ, สวัสดิการ, นิติการ, บัญชี, ฌาปนกิจ, บริการสำนักงาน, อื่นๆ — รายชื่ออยู่ใน `lib/departments.ts`) ส่งต่อผ่านตาราง `DepartmentContact` (precedence อยู่ใน `lib/departmentRouting.ts`):
